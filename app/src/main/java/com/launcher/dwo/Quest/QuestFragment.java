...
import com.launcher.dwo.Generator.QuestGenerator;
...
public class QuestFragment extends Fragment {
    ...
    public QuestSharedPreferences preferencesQuest;
    ...
    private void FirstMethod(final View view) {
        ...
        preferencesQuest = new QuestSharedPreferences(getActivity(), RoomID);
