...
public class CreateClassDataAdapter extends BaseAdapter {
    ...
    public CreateClassDataAdapter(CreateHeroViewModel model, Context c, ViewPager viewPager, boolean isEvil) {
        this.model = model;
        this.mContext = c;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        String imageAddress;
        Log.d("DebugLogs", "CreateClassDataAdapter: " + position);
        ...
        if(!isEvil) {
            imageView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    switch (position) {
                        case 0:
                            Log.d("DebugLogs", "CreateClassDataAdapter: Item knight selected!");
                            role = 1;
                            pager.setCurrentItem(1);
                            break;
                        case 1:
                            Log.d("DebugLogs", "CreateClassDataAdapter: Item mag selected!");
                            role = 2;
                            pager.setCurrentItem(1);
                            break;
                        case 2:
                            Log.d("DebugLogs", "CreateClassDataAdapter: Item rower selected!");
                            role = 3;
                            pager.setCurrentItem(1);
                            break;
                        case 3:
                            Log.d("DebugLogs", "CreateClassDataAdapter: Item thief selected!");
                            role = 4;
                            pager.setCurrentItem(1);
                            break;
                    }
    ...
    private void openGallery(){
        ...
        Log.d("DebugLogs", "CreateClassDataAdapter : ((Activity) mContext).getLocalClassName(): " + ((Activity) mContext).getLocalClassName());
    }
